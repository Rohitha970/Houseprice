...
/* ── FORCE DARK TEXT on main dashboard only ── */
p, span, h1, h2, h3, h4, h5, h6, li, label, div {
    color: var(--text);
}

/* ── LOGIN PAGE — everything white on dark bg ── */
[style*="020b18"] *, [style*="061433"] *,
[style*="0a2070"] *, [style*="1648ff 100%"] * {
    color: white !important;
}

/* ── HERO badges on login page ── */
[style*="rgba(22,72,255,0.3)"] *,
[style*="rgba(0,200,150,0.2)"] *,
[style*="rgba(255,179,0,0.2)"] * {
    color: white !important;
}

/* ── Login/Register card text ── */
[style*="rgba(255,255,255,0.06)"] *,
[style*="rgba(255,255,255,0.07)"] * {
    color: white !important;
}

/* ── NAVBAR (ProProperty AI top bar) — white text ── */
[style*="box-shadow:0 6px 28px rgba(22,72,255"] *,
[style*="box-shadow: 0 6px 28px rgba(22,72,255"] * {
    color: white !important;
}

/* ── TABS — active tab white, inactive readable ── */
.stTabs [aria-selected="true"] * { color: white !important; }
.stTabs [aria-selected="false"] * { color: var(--muted) !important; }
.stTabs [data-baseweb="tab"] p,
.stTabs [data-baseweb="tab"] span { color: inherit !important; }

/* ── SELECTBOX dropdown text — dark so readable on white dropdown ── */
[data-baseweb="select"] *,
[data-baseweb="popover"] *,
[role="listbox"] *,
[role="option"] * { color: #0d1f3c !important; }

/* ── SELECTBOX selected value text ── */
[data-baseweb="select"] [data-testid="stMarkdown"] *,
.stSelectbox [data-baseweb="select"] span { color: #0d1f3c !important; }

/* ── RESULT / ANALYTICS gradient banners — white ── */
[style*="linear-gradient(135deg,#061433"] *,
[style*="linear-gradient(135deg,#00874a"] *,
[style*="linear-gradient(135deg,#1237cc"] *,
[style*="linear-gradient(135deg,#c97000"] *,
[style*="linear-gradient(135deg,#b5003a"] *,
[style*="linear-gradient(135deg,#7b0029"] * { color: white !important; }

/* EXCEPTION: keep .colored-banner white too */
...
<div style='background:linear-gradient(135deg,#061433,#0a2070,#1648ff);
    ...
    <div style='display:flex;align-items:center;gap:10px;color:white;'>
        <span style='font-size:clamp(20px,4vw,28px);color:white;'>🏙️</span>
        <div style='color:white;'>
            <div style='font-size:clamp(15px,3.2vw,20px);font-weight:900;color:white !important;
