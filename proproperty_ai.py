...
if not st.session_state.logged_in:
    ...
    /* Input boxes — bright white typed text, always visible on dark bg */
    ...
    /* Focused / actively typing — even brighter */
    .stApp .stTextInput input:focus {
        background: rgba(255,255,255,0.24) !important;
        color: #ffffff !important;
        -webkit-text-fill-color: #ffffff !important;
        border-color: #00d4ff !important;
        box-shadow: 0 0 0 3px rgba(0,212,255,0.28) !important;
    }
    /* Password field dots also white */
    .stApp .stTextInput input[type="password"] {
        color: #ffffff !important;
        -webkit-text-fill-color: #ffffff !important;
    }
