...
/* ── TABS — white bg, dark inactive, white active ── */
...
div[data-testid="column"]:last-child .stButton > button {
    background: white !important;
    color: #1648ff !important;
    border: 2px solid #1648ff !important;
    font-size: 13px !important;
    font-weight: 700 !important;
...
/* Logout button specifically by key */
button[data-testid="btn_logout_val"] {
    background: #fff0f3 !important;
    color: #ff3d6b !important;
    border: 2px solid #ff3d6b !important;
    box-shadow: none !important;
}
...
/* ── SELECTBOX — always dark text on white ── */
.stSelectbox > div > div,
...
[role="option"],
[role="listbox"] div { color: #0d1f3c !important; background: white !important; }

/* ── TOGGLES — dark label text always, visible on all devices ── */
[data-testid="stToggleLabel"],
[data-testid="stToggleLabel"] p,
[data-testid="stToggleLabel"] span,
[data-testid="stToggleLabel"] div,
[data-testid="stToggleLabel"] label,
.stCheckbox label,
.stCheckbox span,
.stCheckbox div,
/* Broader fallback for Streamlit toggle wrappers */
div[data-testid*="Toggle"] p,
div[data-testid*="Toggle"] span,
...
/* Ensure toggle row container has white background on mobile */
.stToggle, 
[data-testid="stToggle"],
div:has(> [data-testid="stToggleLabel"]) {
    background: white !important;
    border-radius: 10px !important;
...
[data-testid="metric-container"]:hover {
    transform: translateY(-2px) !important;
    box-shadow: 0 6px 28px rgba(22,72,255,0.13) !important;
}
...
/* ── CAPTIONS ── */
.stCaption { color: #5a6a8a !important; font-size: 13px !important; }
...
[data-testid="stExpander"] * { color: #0d1f3c !important; }
...
[data-testid="stFileUploader"] section * { color: #0d1f3c !important; }
[data-testid="stFileUploader"] button {
    background: white !important; color: #1648ff !important;
    border: 2px solid #1648ff !important; border-radius: 8px !important;
    font-weight: 700 !important;
}
[data-testid="stFileUploader"] button * { color: #1648ff !important; }
[data-testid="stFileUploader"] small,
[data-testid="stFileUploader"] span { color: #5a6a8a !important; }
...
/* ── DESKTOP — normal side-by-side columns ── */
[data-testid="column"] {
...
/* ── GLOBAL TEXT VISIBILITY FIX (all white-bg areas on mobile) ── */
/* Ensure ALL text is dark when on light/white backgrounds */
.stApp p, .stApp span, .stApp div, .stApp label,
.stApp li, .stApp small, .stApp caption,
...
/* White surface containers — ensure text is always dark */
[data-testid="stVerticalBlock"] > div > [data-testid="stHorizontalBlock"] *,
.block-container * {
    color: #0d1f3c;
}

/* Number inputs — value text dark */
.stNumberInput input,
.stTextInput input {
    color: #0d1f3c !important;
    -webkit-text-fill-color: #0d1f3c !important;
...
[data-testid="stMetricLabel"] { color: #5a6a8a !important; }
[data-testid="stMetricValue"] { color: #1648ff !important; -webkit-text-fill-color: #1648ff !important; }

/* Overrides for login page — re-applied via inline style block there */
...
@media (max-width: 900px) {
    .stApp p, .stApp span, .stApp div:not([style*="color:white"]):not([style*="color: white"]),
    .stApp label {
        color: #0d1f3c !important;
        -webkit-text-fill-color: #0d1f3c !important;
    }
    /* Re-allow white text on coloured gradient divs */
...
if not st.session_state.logged_in:
    ...
    /* Override global dark text — everything white on login dark bg */
    .stApp p, .stApp span, .stApp div, .stApp label,
    .stApp h1, .stApp h2, .stApp h3, .stApp h4, .stApp h5, .stApp h6,
    .stApp li, .stApp a, [data-testid] p, [data-testid] span,
    [data-testid] div, [data-testid] label { color: white !important; }
    /* Input labels white */
    .stTextInput label, .stTextInput label * { color: white !important; font-weight: 700 !important; }
    /* Input box semi-transparent with white text */
    .stTextInput input {
    ...
    .stTextInput input:focus { border-color: #00d4ff !important; box-shadow: 0 0 0 3px rgba(0,212,255,0.2) !important; }
...
with tab_val:
    ...
    state   = st.selectbox("🗺️ State / Province",
    ...
    # Mobile-fix: inline style to ensure toggle labels are always dark/visible
    st.markdown("""
    <style>
    [data-testid="stToggleLabel"],
    [data-testid="stToggleLabel"] *,
    ...
    .amenity-card {
        ...
        margin-bottom: 12px;
        box-shadow: 0 2px 10px rgba(22,72,255,0.06);
    }
    </style>
    <div class="amenity-card"></div>
    """, unsafe_allow_html=True)
...
with tab_analytics:
    ...
    if df_hist.empty:
        ...
        # Axis template applied to every chart — explicit tickfont & title so
        # axis labels are always dark on mobile (Plotly uses SVG, CSS won't fix it)
        AXIS_STYLE = dict(
            color="#0d1f3c",
            tickcolor="#0d1f3c",
        ...
        fig1.update_layout(**LAYOUT, plot_bgcolor="#f4f8ff",
                           xaxis={**AXIS_STYLE, "tickangle": -40, "gridcolor": "#e8efff"},
                           yaxis={**AXIS_STYLE, "gridcolor": "#e8efff"})
        ...
        fig2.update_layout(**LAYOUT, plot_bgcolor="#fdf4ff",
                           xaxis={**AXIS_STYLE, "gridcolor": "#f0e8ff"},
                           yaxis={**AXIS_STYLE, "gridcolor": "#f0e8ff"})
        ...
        fig3.update_layout(**LAYOUT, plot_bgcolor="#fefce8", showlegend=False,
                           xaxis={**AXIS_STYLE, "gridcolor": "#fff3b0"},
                           yaxis={**AXIS_STYLE, "gridcolor": "#fff3b0"})
        ...
        fig4.update_layout(**LAYOUT, plot_bgcolor="#f0fff8", showlegend=False,
                           xaxis={**AXIS_STYLE, "gridcolor": "#c8f5e8"},
                           yaxis={**AXIS_STYLE, "gridcolor": "#c8f5e8"})
